...
const ChatBot = () => {
    ...
    const API_KEY = 'wk_b74bbb6da5ef57cbfe04372468a920da9211deb7d781c8fc8e5ce3d654be9164';
    const BACKEND_URL = 'https://chat-backend-12wo.onrender.com';
    const WEBSITE_URL = 'https://twitter-bio.netlify.app/';
    ...
    useEffect(() => {
        if (isOpen && messages.length === 0) {
            setMessages([
                {
                    type: 'bot',
                    text: 'Hi! I\'m your Twitter Bio assistant. How can I help you today?',
                    timestamp: new Date(),
                },
            ]);
        }
